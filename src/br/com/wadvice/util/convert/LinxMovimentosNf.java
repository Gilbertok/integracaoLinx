...
public class LinxMovimentosNf {

	public static List<MovimentosNfModel> convertStringXmlToObjects(String xml) {
	...
	public static void gravar(List<MovimentosNfModel> movimentos) {
