...
public class MovimentosNfDao extends DefaultDao {
	...
	private void insert(MovimentosNfModel movimento) throws SQLException {
		...
		stmt.setDate(10, movimento.getDataDocuemnto() != null ? new Date(movimento.getDataDocuemnto().getTime()) : null);
		stmt.setDate(11, movimento.getDataLancamento() != null ? new Date(movimento.getDataLancamento().getTime()) : null);
		...
		stmt.setDate(63, movimento.getHoraLancamento() != null ? new Date(movimento.getHoraLancamento().getTime()) : null);
		...
		stmt.setDate(70, movimento.getDataUpdate() != null ? new Date(movimento.getDataUpdate().getTime()) : null);
	...
	private void update(MovimentosNfModel movimento) throws SQLException {
		...
		stmt.setDate(7, movimento.getDataDocuemnto() != null ? new Date(movimento.getDataDocuemnto().getTime()) : null);
		stmt.setDate(8, movimento.getDataLancamento() != null ? new Date(movimento.getDataLancamento().getTime()) : null);
		...
		stmt.setDate(60, movimento.getHoraLancamento() != null ? new Date(movimento.getHoraLancamento().getTime()) : null);
		...
		stmt.setDate(67, movimento.getDataUpdate() != null ? new Date(movimento.getDataUpdate().getTime()) : null);
